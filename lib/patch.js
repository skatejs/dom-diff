(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', './types', './patch/append-child', './patch/remove-attribute', './patch/remove-child', './patch/set-attribute', './patch/text-content'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('./types'), require('./patch/append-child'), require('./patch/remove-attribute'), require('./patch/remove-child'), require('./patch/set-attribute'), require('./patch/text-content'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.types, global.appendChild, global.removeAttribute, global.removeChild, global.setAttribute, global.textContent);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _types, _patchAppendChild, _patchRemoveAttribute, _patchRemoveChild, _patchSetAttribute, _patchTextContent) {
  'use strict';
