(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(exports, require('./types'), require('./patch/append-child'), require('./patch/remove-attribute'), require('./patch/remove-child'), require('./patch/replace-child'), require('./patch/set-attribute'), require('./patch/set-event'), require('./patch/text-content'));
  } else {
    var mod = {
      exports: {}
    };
...
})(this, function (exports, _types, _appendChild, _removeAttribute, _removeChild, _replaceChild, _setAttribute, _setEvent, _textContent) {
  'use strict';
