(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', './types', './compare/node', './util/real-node', './util/real-node-map'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('./types'), require('./compare/node'), require('./util/real-node'), require('./util/real-node-map'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.types, global.compareNode, global.realNode, global.realNodeMap);
    global.diff = mod.exports;
  }
})(this, function (exports, module, _types, _compareNode, _utilRealNode, _utilRealNodeMap) {
  'use strict';
    ...
    for (var a = 0; a < dstChsLen; a++) {
      ...
      if (!curSrc) {
        ...
        if (!(curDst instanceof Node)) {
          _realNodeMap['default'].set(curDst, (0, _realNode['default'])(curSrc));
        }
      }
