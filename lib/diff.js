(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(exports, require('./types'), require('./compare/node'), require('./util/real-node'), require('./util/real-node-map'));
  } else {
    var mod = {
      exports: {}
    };
...
})(this, function (exports, _types, _node, _realNode, _realNodeMap) {
  'use strict';
